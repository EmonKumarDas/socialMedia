        ...
        <div className="rounded-md shadow-md my-8 dark:bg-[#242526] dark:text-gray-100">
            ...
            <div className="flex items-center justify-between p-3">
                <div className="flex items-center space-x-2">
                    <img src={ProfilePhoto} alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm dark:bg-gray-500 dark:border-gray-700" />
            ...
            <p className='text-gray-400 py-2 px-2'>{post}</p>
            <img src={postimage} alt="" className="object-cover object-center w-full dark:bg-gray-500" />
            <div className="p-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        <button onClick={handleClick} type="button" title="Like post" className="flex items-center justify-center">
                            {
                                isLoved ? <FaHeart className='text-red-500 w-5 h-5'></FaHeart> : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current">
                ...
                <div className="flex flex-wrap items-center pt-3 pb-1">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">Liked
                            <span className="font-semibold"> </span>
                            <span className="font-semibold"> {like} and others</span>
                        </span>
                    </div>
                </div>
                <div className="relative space-y-3">
                    ...
                    <form onSubmit={handleComment} action="">
                        <input type="text" name="comment" placeholder=" Add a comment..." className="w-full h-16 py-0.5 rounded text-sm pl-0 " />
                        <button className='absolute top-14 left-[90%] text-xl'>{loading ? "Wait..." : <FaGooglePlay ></FaGooglePlay>}</button>
                    </form>
                </div>
            </div>
